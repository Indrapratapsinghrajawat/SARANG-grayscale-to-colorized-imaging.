...
const Defense = () => {
  return (
    <Layout>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-amber-500/20 mb-8 animate-fade-up opacity-0 stagger-1">
              <Shield className="h-4 w-4 text-amber-500" />
              <span className="text-sm text-amber-400">Defense & Surveillance</span>
            </div>

            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-up opacity-0 stagger-2">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mb-8 animate-fade-up opacity-0 stagger-3">
            ...
            <div className="flex flex-wrap gap-3 animate-fade-up opacity-0 stagger-4">
              {["Tactical Intelligence", "Night Operations", "All-Weather Capability"].map((tag) => (
                <span key={tag} className="px-4 py-2 rounded-full text-sm bg-amber-500/10 text-amber-400 border border-amber-500/20">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Strategic <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Capabilities</span>
            </h2>
            ...
            {capabilities.map((cap, index) => (
              <div key={index} className="glass rounded-2xl p-6 text-center card-hover">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber-500/10 flex items-center justify-center">
                  <cap.icon className="h-8 w-8 text-amber-500" />
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                  Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Colorization</span> Enhances Intelligence
                </h2>
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Defense <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Applications</span>
            </h2>
            ...
            {applications.map((app, index) => (
              <div key={index} className="glass rounded-2xl p-6 card-hover group">
                <div className="p-3 rounded-xl bg-amber-500/10 group-hover:bg-amber-500/20 transition-colors w-fit mb-4">
                  <app.icon className="h-6 w-6 text-amber-500" />
                </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="glass rounded-3xl p-12 max-w-5xl mx-auto border-amber-500/20">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-4xl font-display font-bold text-amber-400 mb-2">24/7</div>
                <p className="text-sm text-muted-foreground">Continuous Monitoring</p>
              </div>
              <div>
                <div className="text-4xl font-display font-bold text-amber-400 mb-2">100%</div>
                <p className="text-sm text-muted-foreground">Weather Independence</p>
              </div>
              <div>
                <div className="text-4xl font-display font-bold text-amber-400 mb-2">10x</div>
                <p className="text-sm text-muted-foreground">Faster Interpretation</p>
              </div>
              <div>
                <div className="text-4xl font-display font-bold text-amber-400 mb-2">∞</div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="glass rounded-3xl p-12 text-center max-w-4xl mx-auto border-amber-500/20">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="border-amber-500/50 text-amber-400 hover:bg-amber-500/10" asChild>
