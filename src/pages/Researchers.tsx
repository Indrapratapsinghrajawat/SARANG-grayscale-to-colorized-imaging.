    ...
    <Layout>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-emerald-500/20 mb-8 animate-fade-up opacity-0 stagger-1">
              <FlaskConical className="h-4 w-4 text-emerald-500" />
              <span className="text-sm text-emerald-400">Research Applications</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3 animate-fade-up opacity-0 stagger-4">
              {["All-Weather Monitoring", "Day & Night Imaging", "Texture Preservation"].map((tag) => (
                <span key={tag} className="px-4 py-2 rounded-full text-sm bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Colorization</span> Matters
            </h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Research <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Applications</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {applications.map((app, index) => (
              <div key={index} className="glass rounded-2xl p-6 card-hover group">
                <div className="p-3 rounded-xl bg-emerald-500/10 group-hover:bg-emerald-500/20 transition-colors w-fit mb-4">
                  <app.icon className="h-6 w-6 text-emerald-500" />
                </div>
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Supporting <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">UN SDGs</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            {sdgGoals.map((sdg, index) => (
              <div key={index} className="glass rounded-2xl p-8 text-center card-hover">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 flex items-center justify-center border border-emerald-500/30">
                  <span className="font-display text-2xl font-bold text-emerald-400">SDG {sdg.number}</span>
                </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="glass rounded-3xl p-12 text-center max-w-4xl mx-auto border-emerald-500/20">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
