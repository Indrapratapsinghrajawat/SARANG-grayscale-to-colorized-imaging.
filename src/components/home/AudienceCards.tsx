          ...
          <div className="glass rounded-2xl p-8 card-hover group">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {["All-Weather Imaging", "Night Operations", "Tactical Intelligence"].map((tag) => (
                <span key={tag} className="px-3 py-1 rounded-full text-xs bg-amber-500/10 text-amber-400 border border-amber-500/20">
                  {tag}
                </span>
              ))}
            </div>

            <Button variant="outline" className="w-full border-amber-500/50 text-amber-400 hover:bg-amber-500/10" asChild>
